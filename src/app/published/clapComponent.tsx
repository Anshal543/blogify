...
const ClapComponent = ({ storyId, clapCount, commentId, userClaps }: Props) => {
  ...
  return (
    <button onClick={clapStoryOrComment} className="flex items-center relative">
      <span
        className={`absolute bottom-10 w-[40px] h-[40px] bg-black rounded-full shadow-2xl shadow-neutral-300
      text-white flex items-center justify-center duration-75 ease-in ${
        showPopup
