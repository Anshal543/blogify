    ...
    <div className="flex items-center justify-center mt-6 max-w-[800px] mx-auto">
        <div>
            ...
            <div className="flex items-center space-x-5">
                <Image src={AutherImage} width={44} height={44} className="rounded-full" alt="User" />
                <div className='text-sm'>
                    <p>{AuthorFirstName} <span className="font-medium text-red-400 cursor-pointer">. Follow</span> </p>
